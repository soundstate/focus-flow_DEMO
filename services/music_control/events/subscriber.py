"""Redis pub/sub subscriber for Music Control service.

Listens for events from other services (Focus Engine) and dispatches
...
async def start_subscriber(redis_client, db_session_factory, publisher=None):
    ...
    logger.info("Music Control subscriber started, listening for events...")
