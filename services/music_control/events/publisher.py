"""Redis pub/sub event publisher for Music Control service."""
import json
import logging
...
class EventPublisher:
    """Publishes music control events to Redis pub/sub channels."""
    ...
    async def publish(self, event_type: str, user_id: str, payload: dict) -> None:
        ...
        Args:
            event_type: The event channel name (e.g. 'music.track_changed').
