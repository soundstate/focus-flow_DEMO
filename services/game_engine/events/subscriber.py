"""Redis pub/sub subscriber for Game Engine.

Listens for events from other services (e.g. Focus Engine) and dispatches
...
async def start_subscriber(redis_client, db_session_factory, publisher=None):
    ...
    logger.info("Game Engine subscriber started, listening for events...")
